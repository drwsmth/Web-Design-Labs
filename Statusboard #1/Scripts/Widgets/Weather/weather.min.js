...
function setConditions(conditions, conditions_img, temp, humidity) {
	...
	$("#weather_widget").append("<img id='weather_img' src='http://web.me.com/drew_smith/Stratus/Scripts/Widgets/Weather/" + conditions_img + "' />");
	$("#weather_widget").append("</p><p id='weather_cond'>" + "</p></div>");
}